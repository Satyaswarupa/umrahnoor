...
export default function WhatsAppFloatButton() {
  return (
    <a
      ...
      className="fixed bottom-4 left-4 z-40 flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] shadow-lg transition hover:scale-105 sm:bottom-6 sm:left-6"
    >
